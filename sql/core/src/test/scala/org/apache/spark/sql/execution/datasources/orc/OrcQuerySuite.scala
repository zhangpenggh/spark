...
<<<<<<< HEAD:sql/hive/src/test/scala/org/apache/spark/sql/hive/orc/OrcQuerySuite.scala
...
>>>>>>> master:sql/core/src/test/scala/org/apache/spark/sql/execution/datasources/orc/OrcQuerySuite.scala
