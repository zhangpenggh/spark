...
<<<<<<< HEAD:sql/core/src/test/scala/org/apache/spark/sql/streaming/DeduplicateSuite.scala
...
>>>>>>> master:sql/core/src/test/scala/org/apache/spark/sql/streaming/StreamingDeduplicationSuite.scala
}
